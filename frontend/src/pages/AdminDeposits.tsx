...
import {
  ...
  AdminDeposit,
  UpdateDepositData,
} from "../services/adminDepositsService";
...
const AdminDeposits = () => {
  ...
  const handleStatusUpdate = async (
    ...
    try {
      ...
      setError(
        err instanceof Error ? err.message : "Грешка при обновяване на статуса",
      );
    } finally {
      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="mb-8">
          ...
          <p className="text-gray-600">
            Администрирайте всички депозити в системата
          </p>
        </div>
        ...
        {deposits.length === 0 ? (
          <div className="bg-white rounded-lg shadow p-8 text-center">
            ...
            <p className="mt-1 text-sm text-gray-500">
              Все още няма създадени депозити в системата.
            </p>
          </div>
        ) : (
                          ...
                          <div className="flex space-x-2">
                            {deposit.status === "pending" && (
                              <>
                                <button
                                  onClick={() =>
                                    handleStatusUpdate(deposit._id, {
                                      status: "approved",
                                    })
                                  }
